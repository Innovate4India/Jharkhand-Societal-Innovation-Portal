...
export function RegisterForm() {
  ...
  async function submit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const fieldsByRole: Record<Role, string[]> = { Citizen: ['mobile', 'district', 'villageOrCity'], Government: ['department', 'designation', 'governmentDistrict'], University: ['institution', 'universityDepartment', 'accountType'], Industry: ['organizationName', 'organizationType', 'expertise'] }
